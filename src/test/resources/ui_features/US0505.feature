@m
Feature: US0505 Hastalar (patients), hastahaneden randevu (Appointment) oluşturabilmelidir.

  Background: US05 Ortak adimlar
    Given Kullanici "medunnaUrl" ana sayfasina gider
