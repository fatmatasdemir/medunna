...
public class DatabaseUtility {
        ...
        public static void createConnection() {   //datasiz
        ...
        public static void createConnection(String url, String user, String password) {  //datali datalar disaridan gelir)
            try {
                connection = DriverManager.getConnection(url, user, password);
            } catch (SQLException e) {
                // TODO Auto-generated catch block
         ...
         */     // bir sira map data ornegi gonderir
    ...
    // eger biz parametre olarak queryi verip gelen sonucu direkt string olarak yazdirmak istiyorsak



// eger biz parametre olarak queryi verip gelen sonucu direkt string list olarak yazdirmak istiyorsak
