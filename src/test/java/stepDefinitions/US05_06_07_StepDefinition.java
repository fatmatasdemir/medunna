...
public class US05_06_07_StepDefinition {
 ...
 public void emailBilgisininDogrulugunuKontrolEder() {
  Assert.assertEquals(US05_06_07.emailTextbox.getAttribute("value"), ConfigReader.getProperty("userEmail"));
 }
 ...
 public void kullaniciGecerliBilgileriGirer() {
  US05_06_07.firstnameTextbox.sendKeys(ConfigReader.getProperty("patientFirstname"));
  US05_06_07.lastnameTextbox.sendKeys(ConfigReader.getProperty("patientLastname"));
  US05_06_07.emailTextbox.sendKeys(ConfigReader.getProperty("patientEmail"));
  US05_06_07.phoneBox.sendKeys(ConfigReader.getProperty("phonePatient"));
  US05_06_07.SSN.sendKeys(ConfigReader.getProperty("SSN"));
    ...
    public void kullaniciEkrandaAppointmentRegistrationSavedMesajiniGorememeli() {
       assertFalse("Appointment registration saved mesaji görüldü",US05_06_07.AppointmentRegistrationSaved.isDisplayed());
    }

  @And("Kullanici randevu tarihini  secer")
  public void kullaniciRandevuTarihiniSecer() {

   US05_06_07.appoDate.sendKeys("18122022");
 }
}